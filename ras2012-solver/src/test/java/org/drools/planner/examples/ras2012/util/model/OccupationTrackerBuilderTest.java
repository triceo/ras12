...
public class OccupationTrackerBuilderTest {
    ...
    public void testDirectionAdjustment() {
        final Route westboundRoute = new Route.Builder(false).build();
        final Route eastboundRoute = new Route.Builder(true).build();
        final Arc a = new Arc(Track.MAIN_0, BigDecimal.ONE, Node.getNode(0), Node.getNode(1));
        // two full ranges; result should be equal
        final ArcRange r1 = new Builder(eastboundRoute).create(a, BigDecimal.ZERO, BigDecimal.ONE);
        final ArcRange r2 = new Builder(westboundRoute).create(a, BigDecimal.ZERO, BigDecimal.ONE);
        ...
        final ArcRange r3 = new Builder(eastboundRoute).create(a, BigDecimal.ZERO, new BigDecimal(
                "0.5"));
        final ArcRange r4 = new Builder(westboundRoute).create(a, new BigDecimal("0.5"),
                BigDecimal.ONE);
        ...
        final ArcRange r5 = new Builder(eastboundRoute).create(a, BigDecimal.ZERO, new BigDecimal(
                "0.5"));
        final ArcRange r6 = new Builder(westboundRoute).create(a, BigDecimal.ZERO, new BigDecimal(
                "0.5"));
