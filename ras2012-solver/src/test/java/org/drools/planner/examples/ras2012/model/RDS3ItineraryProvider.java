...
public class RDS3ItineraryProvider extends ItineraryProvider {
    ...
    private static final int    TRAIN2_ROUTE1  = 287;
    private static final int    TRAIN3_ROUTE0  = 5;
    private static final int    TRAIN3_ROUTE1  = 383;
    private static final int    TRAIN4_ROUTE0  = 108;
    private static final int    TRAIN4_ROUTE1  = 338;
    private static final int    TRAIN5_ROUTE0  = 9;
    private static final int    TRAIN5_ROUTE1  = 379;
    private static final int    TRAIN6_ROUTE0  = 14;
    private static final int    TRAIN6_ROUTE1  = 266;
    ...
    private static final int    TRAIN8_ROUTE1  = 191;
    private static final int    TRAIN9_ROUTE0  = 60;
    private static final int    TRAIN9_ROUTE1  = 170;
    private static final int    TRAIN10_ROUTE0 = 3;
    private static final int    TRAIN10_ROUTE1 = 351;
    private static final int    TRAIN11_ROUTE0 = 204;
    private static final int    TRAIN11_ROUTE1 = 314;
